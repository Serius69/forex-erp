...
export default function ReportsScreen() {
  ...
  return (
    ...
    >
      ...
      {loading ? (
        <View style={styles.center}><ActivityIndicator color="#2E75B6" size="large" /></View>
      ) : (
        <>
          {/* KPIs */}
          {summary && (
          ...
          <View style={styles.tableCard}>
            ...
            {report.length === 0 ? (
              <Text style={styles.emptyText}>Sin operaciones para esta fecha.</Text>
            ) : (
...
const styles = StyleSheet.create({
  ...
  emptyText: { textAlign: 'center', color: '#AAB4BE', paddingVertical: 30, fontSize: 14 },
});
