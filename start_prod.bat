...
cd ..
start "Backend PROD" cmd /k "cd backend && venv\Scripts\activate && set DJANGO_SETTINGS_MODULE=core.settings.production && uvicorn core.asgi:application --host 0.0.0.0 --port 8000 --workers 2 --log-level warning"
